...
public class UserControllerTest {
    ...
    public void testhandle41() {
        ...
        restTemplate.postForLocation(
                "http://localhost:8088/chapter7/user/handle41.html", form);
    }
    ...
    public void testhandle42() throws IOException {
        ...
        byte[] response = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/handle42/{itemId}.html", null, byte[].class, "1233");
    ...
    public void testhandle43() {
        ...
        form.add("age", "45");
        restTemplate.postForLocation(
                "http://localhost:8088/chapter7/user/handle43.html", form);
    }
    ...
    public void testhandle44() throws IOException {
        RestTemplate restTemplate = new RestTemplate();
        byte[] response = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/handle44/{itemId}.html", null, byte[].class, "1233");
        Resource outFile = new FileSystemResource("d:/image_copy.jpg");
        FileCopyUtils.copy(response, outFile.getFile());
    }
    ...
    public void testhandle51WithXml() {
        ...
        ResponseEntity<User> responseEntity = restTemplate.exchange(
                "http://localhost:8088/chapter7/user/handle51.html",
    ...
    public void testmodel1() {
        ...
        String html = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/model1.html", form, String.class);
    ...
    public void testmodel2() {
        RestTemplate restTemplate = new RestTemplate();
        String html = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/model2.html", null, String.class);
        Assert.assertNotNull(html);
    ...
    public void testmodel3() {
        RestTemplate restTemplate = new RestTemplate();
        String html = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/model3.html", null, String.class);
        Assert.assertNotNull(html);
        Assert.assertTrue(html.indexOf("1001") > -1);
    }
    ...
    public void testmodel4() {
        ...
        form.add("password", "123456");
        form.add("age", "45");
        restTemplate.postForLocation("http://localhost:8088/chapter7/user/model4.html", form);
    }
    ...
    public void testhandle81() {
        ...
        String html = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/handle81.html", form, String.class);
        Assert.assertNotNull(html);
    ...
    public void testhandle82() {
        ...
        String html = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/handle82.html", form, String.class);
        Assert.assertNotNull(html);
        Assert.assertTrue(html.indexOf("tom") > -1);
    }
    ...
    public void testvalid1() {
        ...
        form.add("salary", "4,500.00");
        String html = restTemplate.postForObject(
                "http://localhost:8088/chapter7/user/valid1.html", form, String.class);
        Assert.assertNotNull(html);
        Assert.assertTrue(html.indexOf("tom") > -1);
    }
}
