package com.smart.web.selenium;
...
public class LoginControllerTest {
    ...
    public void loginCheck(){
        ...
        driver.get("http://localhost/chapter8/index.html");
        ...
        //验证返回的主页面 main.jsp
        assertThat(driver.getTitle(), equalTo("景区后台管理"));
        assertThat(driver.getPageSource(), containsString("admin"));
        WebElement body  = driver.findElement(By.xpath( "//body" ));
        assertThat(body.getText(), containsString("admin,景区后台管理"));
    }
